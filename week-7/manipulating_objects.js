...
//
// I had trouble adding new properties with a value. I thought that we'd be able to do object.newproperty = somevalue, but that doesn't work when you first create an object, and it didn't seem to work for our nested objects (when we assigned terah's children their names). I used the object literal notation to make it work.

//How difficult was it to add and delete properties outside of the object itself?
//Adding and deleting properties outside of the object itself was straightforward once the object had been created and added some variables. I couldn't get the property to delete by assigning it to null, it would only work if I assigned it to undefined.
//What did you learn about manipulating objects in this challenge?
//It reminds me of hash variables in Ruby, however, nested objects  didn't behave the way that I expected to. It seems like you have to use object literal notation to assign the first property.
