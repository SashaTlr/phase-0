...
#This review assignment was extremely helpful. It solidified the
#basics of inheritance and how it can be useful. It also demystified
#the value of attr_accessors and when they are useful. Used case
#statements for the first time, as I didn't realize how a range
#would work for the case statement, so mostly used if statements
#instead.

#What is still confusing to you about Ruby?
#Right now, I'm feeling pretty comfortable with Ruby, although I am
#sure that will change going into the immersive.

#What are you going to study to get more prepared for Phase 1?
#I think I will do more work on objects and inheritance before Phase
#1 starts. I'm also going to explore CSS and bootstrapping
#frameworks first.