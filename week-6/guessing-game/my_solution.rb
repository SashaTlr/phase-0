...
#   GuessingGame#solved?: returns true if most recent guess was correct
# Steps:
#Guess method:
#  1) Define method with guess argument
#  2) Compare guess to answer. Guess can be higher, lower, or correct compared to answer.
#  3) Solved input is the symbol from guess. If it's correct, then the method returns true.
...
#Explain how to use flow control. Did you have any trouble using it in this challenge? If so, what did you struggle with?
  # I had trouble passing the guess result into solved. I wasn't sure how to return the result to solved without having to return the guess number that was used in the last guess method. I realized that I could initialize a variable that holds the last result of the guess method, and pass that into solved?.
